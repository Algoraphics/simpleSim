...
class VehicleController {
	...
	public:
		...
		static void steering_controller(double *omega, double *delta_d, int *path_index, double x, double y, double velocity, double heading, double tire_angle, double *path_x, double *path_y, int flag);
		static double fromAngleToAngle(double from, double to);
		static double wrapTo2Pi(double angle);
		static double wrapToPi(double angle);

		static void comfort_controller(double *acceleration, int path_index, double x, double y, double velocity, double heading, double tire_angle, double *path_x, double *path_y, double *lod_x, double *lod_y);
