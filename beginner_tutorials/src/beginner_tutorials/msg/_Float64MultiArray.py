"""autogenerated by genpy from beginner_tutorials/Float64MultiArray.msg. Do not edit."""
import sys
...
class Float64MultiArray(genpy.Message):
  ...
  _type = "beginner_tutorials/Float64MultiArray"
...
================================================================================
MSG: beginner_tutorials/MultiArrayLayout
...
================================================================================
MSG: beginner_tutorials/MultiArrayDimension
string label   # label of given dimension
uint32 size    # size of given dimension (in type units)
uint32 stride  # stride of given dimension
"""
  __slots__ = ['layout','data']
  _slot_types = ['beginner_tutorials/MultiArrayLayout','float64[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.layout is None:
        self.layout = beginner_tutorials.msg.MultiArrayLayout()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = beginner_tutorials.msg.MultiArrayDimension()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
